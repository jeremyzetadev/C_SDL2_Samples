...
int main(void){
    ...
    stbi_write_jpg("skyGRAY.jpg", width, height, gray_channels, gray_img, 100);
    // stbi_write_png("skyGRAY.png", width, height, gray_channels, gray_img, width*gray_channels);
    // Convert the input image to gray
    ...
    //stbi_write_jpg("skySEPIA.jpg", width, height, channels, sepia_img, 100);
    stbi_write_png("skySEPIA.png", width, height, channels, sepia_img, width * channels);
    // Convert the input image to sepia
